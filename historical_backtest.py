    ...
    for idx, date_str in enumerate(date_range, 1):
        ...
        for race in races:
            ...
            record = {
                ...
                "horse":          top["horse"],
                "horse_id":       horse_id,
                # Breeding & bio (Pro — capture now, before any downgrade)
                "sire":           top_runner.get("sire"),
                "sire_id":        top_runner.get("sire_id"),
                "dam":            top_runner.get("dam"),
                "damsire":        top_runner.get("damsire"),
                "age":            top_runner.get("age"),
                "sex":            top_runner.get("sex"),
                "colour":         top_runner.get("colour"),
                "dob":            top_runner.get("dob"),
                "score":          composite,
                "grade":          top["grade"],
