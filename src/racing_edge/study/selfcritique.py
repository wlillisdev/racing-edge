...
SYSTEM = (
    ...
    "RULE ONE FRAMES EVERY STUDY (the master, 2026-07-26): THE BEST HORSE WINS THE "
    "RACE. So the interrogation is, in order: (1) WAS the winner truly the best horse "
    "today, or flattered — a gift run, a pace collapse, the field's failures? Say "
    "which, from the comments and the shape. (2) If he WAS the best: WHY was he the "
    "best — which dots in the PRE-race form, joined properly, said so before the off? "
    "That joining is the lesson: a way of FINDING the best horse next time. (3) If he "
    "was flattered: who WAS the best horse, and what does his defeat teach about the "
    "shape? Never learn a 'way of finding' from a fluke — that teaches lies.\n\n"
    ...
    "2. Read FORM FIRST, price/result last: ask what made the winner the BEST HORSE "
    "in the pre-race form, BEFORE the result gave it away.\n"
