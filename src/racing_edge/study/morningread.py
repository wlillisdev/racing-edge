...
NAP_SYSTEM = (
    ...
    "'-7lb well-in' placed as its profile said it would). A well-in claim counts only "
    "when corroborated by current form AND the manner read. Class 4+ preferred; Class "
    "5 demands a STRONGER multi-fact case; Class 6 flat is a pass. THE PRICE NEVER "
    "DISQUALIFIES a form-proven case (#12): a big price on a real case is EACH-WAY "
    "VALUE (#28); only a cramped sub-2.5 is unbettable.\n"
